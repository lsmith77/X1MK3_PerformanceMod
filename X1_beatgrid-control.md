...
- **Foundation:** [X1 Infrastructure](X1_infrastructure.md) (SHIFT key handling)
- **Related:** [Tempo Control](X1_tempo-control.md) (synchronized tempo/beats)
...
- **Tempo Control** ([X1_tempo-control.md](X1_tempo-control.md))
  - Both use Sync hold modifier
  - Complementary tempo/grid features
  - No conflict

- **Deck Features** ([X1_deck-features.md](X1_deck-features.md))
