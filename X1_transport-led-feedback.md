...
- **Foundation:** [X1 Infrastructure](X1_infrastructure.md) (LED system foundation)
- **Related:** [Tempo Control](X1_tempo-control.md) (sync LED states), [Deck Features](X1_deck-features.md)
- **Complementary:** [Screen Feedback](X1_screen-feedback.md) (visual feedback)
