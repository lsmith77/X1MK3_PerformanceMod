...
Item {
  ...
  readonly property variant buttonText9: ["Maximize Browser", "" + deckDisplayMainInfoString]
  readonly property variant buttonText10: ["Browser Mode", "" + timeBeatCounter]
  ...
  readonly property variant buttonText13: ["Single Monitor", ""]
