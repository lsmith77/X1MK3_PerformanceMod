...
- **Foundation:** [X1 Infrastructure](X1_infrastructure.md) (SHIFT key handling, state management)
- **Related:** [Beatgrid Control](X1_beatgrid-control.md) (beat position management)
- **Feedback:** [Transport LED Feedback](X1_transport-led-feedback.md), [Screen Feedback](X1_screen-feedback.md)
...
- **X1 Infrastructure** ([X1_infrastructure.md](X1_infrastructure.md))
...
- **Beatgrid Control** ([X1_beatgrid-control.md](X1_beatgrid-control.md))
  - Complementary tempo/grid features
  - Both use SYNC modifier, no conflict

- **Transport LED Feedback** ([X1_transport-led-feedback.md](X1_transport-led-feedback.md))
  - Shows SYNC button state colors
  - No conflict

- **Screen Feedback** ([X1_screen-feedback.md](X1_screen-feedback.md))
