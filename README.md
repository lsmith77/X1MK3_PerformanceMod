...
**[X1 Infrastructure](X1_infrastructure.md)** - Foundation feature  
...
**[Tempo Control](X1_tempo-control.md)** - Sync tap/hold behavior + BPM adjustment
...
**[Beatgrid Control](X1_beatgrid-control.md)** - Manual beat sync + grid marker management
...
**[Deck Features](X1_deck-features.md)** - Display options + vinyl break + beats counter
...
**[Browser Mode](X1_browser-mode.md)** - Track navigation + loading + preview player control
...
**[FX Section](X1_fx-section.md)** - Effect unit assignment + overlay control
...
**[Mixer Overlay](X1_mixer-overlay.md)** - Custom knob/button assignment system
...
**[Stem/Remix Controls](X1_stem-remix-controls.md)** - Superknob + capture source + quantization + beat counter
...
**[Transport LED Feedback](X1_transport-led-feedback.md)** - CDJ-style LED colors + CuePoint blinker
...
**[Screen Feedback](X1_screen-feedback.md)** - Visual indicators + screen-based feedback
...
1. **[X1_infrastructure.md](X1_infrastructure.md)** - Foundation layer
2. **[X1_tempo-control.md](X1_tempo-control.md)** - Sync/BPM control
3. **[X1_beatgrid-control.md](X1_beatgrid-control.md)** - Beat sync/markers
4. **[X1_deck-features.md](X1_deck-features.md)** - Display/vinyl break
5. **[X1_browser-mode.md](X1_browser-mode.md)** - Navigation/loading
6. **[X1_mixer-overlay.md](X1_mixer-overlay.md)** - Knob assignments
7. **[X1_stem-remix-controls.md](X1_stem-remix-controls.md)** - Superknobs/quantize
8. **[X1_transport-led-feedback.md](X1_transport-led-feedback.md)** - LED colors
9. **[X1_fx-section.md](X1_fx-section.md)** - FX control
10. **[X1_screen-feedback.md](X1_screen-feedback.md)** - Visual indicators
11. **[X1_overmapping-support.md](X1_overmapping-support.md)** - Advanced overmapping
...
**...control tempo?**  
→ [Tempo Control](X1_tempo-control.md) (Sync hold vs tap, BPM adjustment)

**...set beat position?**  
→ [Beatgrid Control](X1_beatgrid-control.md) (Manual beat tap, grid markers)

**...browse and load tracks?**  
→ [Browser Mode](X1_browser-mode.md) (Navigate, load, preview)

**...work with FX?**  
→ [FX Section](X1_fx-section.md) (FX unit control, overlays)

**...customize mixer controls?**  
→ [Mixer Overlay](X1_mixer-overlay.md) (Knob assignments, button setup)

**...control Remix/Stem?**  
→ [Stem/Remix Controls](X1_stem-remix-controls.md) (Superknob, quantization)
...
→ [X1 Infrastructure](X1_infrastructure.md) (Foundation layer)
...
- Capture Source Selection - documented in [Stem/Remix Controls](X1_stem-remix-controls.md)
...
- FX Overmapping Modifier (R1) - documented in [Overmapping Support](X1_overmapping-support.md)
- EQ Kill Button Combinations - mentioned in [Mixer Overlay](X1_mixer-overlay.md) but extended options not fully documented
...
- **Traktor Effects Library** - FX provided by Traktor; X1 controls selection/parameters via [FX Section](X1_fx-section.md)
